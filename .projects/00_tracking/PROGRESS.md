...
- Highest-leverage remaining: Vol Cone subpane (~1 evening, FeatureChart enhancement following S19/S22 AVWAP precedent).
- RC1 tester feedback still pending on parallel track.
- Phase 4 deferred — don't re-propose without fresh user signal.
